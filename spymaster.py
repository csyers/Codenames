'''
Name: Christopher Syers, Laura Syers
Date: January 3, 2017
...
class SpyConnection(Protocol):
	"""SpyConnection: connection class of spymaster. Connect to 
	player.py, pass along events"""
	...
	def connectionMade(self):
		"""connectionMade: Once the connection to player is made,
